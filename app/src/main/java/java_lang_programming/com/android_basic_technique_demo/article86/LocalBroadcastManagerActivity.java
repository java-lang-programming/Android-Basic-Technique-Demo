...
import java_lang_programming.com.android_basic_technique_demo.article86.kotlin.KtLocalBroadcastManagerFooterFragment;
...
public class LocalBroadcastManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft.replace(R.id.footer_container, KtLocalBroadcastManagerFooterFragment.newInstance());
